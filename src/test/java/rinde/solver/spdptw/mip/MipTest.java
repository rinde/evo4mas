...
public class MipTest {
    ...
    public void testBig() {
        ...
        final Solver mip = SolverDebugger.wrap(SolverValidator
                .wrap(new MipSolver()));
        final SolutionObject solution = mip
                .solve(travelTime, releaseDates, dueDates, servicePairs, serviceTimes);
    ...
    public void testBig2() {
        final int[][] travelTime = { { 0, 286, 115, 257, 19, 149, 189, 0 },
                { 286, 0, 370, 461, 304, 155, 276, 286 },
                { 115, 370, 0, 320, 105, 217, 300, 115 },
                { 257, 461, 320, 0, 248, 379, 193, 257 },
                { 19, 304, 105, 248, 0, 167, 195, 19 },
                { 149, 155, 217, 379, 167, 0, 237, 149 },
                { 189, 276, 300, 193, 195, 237, 0, 189 },
                { 0, 286, 115, 257, 19, 149, 189, 0 } };
        final int[] releaseDates = { 0, 1247680, 3696240, 6496460, 9785300,
                136910, 2282530, 0 };
        final int[] dueDates = { 0, 3965640, 11615000, 11164000, 11711000,
                8429800, 11541000, 12029000 };
    ...
    static int[] createServiceTimes(int val, int length) {
