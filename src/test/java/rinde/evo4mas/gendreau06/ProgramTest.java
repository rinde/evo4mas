...
public class ProgramTest {
    ...
    public static void main(String[] args) throws IOException {
        ...
        final Collection<GPFunc<GendreauContext>> funcs =
                new AuctionFunctions().create();
        final GPProgram<GendreauContext> prog =
                GPProgramParser.parseProgramFunc(progString, funcs);
        ...
        // prog, 10, false, 1000, SolutionType.RANDOM);
        //
        // task.run();
        //
        // final Gendreau06ObjectiveFunction obj = new
