...
public class RoutePlannerTest {
	...
	public void setUp() {
		...
		for (int i = 0; i < numOnMap; i++) {
			events.add(newParcelEvent(new Point(rng.nextDouble() * 5, rng.nextDouble() * 5), new Point(
	...
	public void testRouteCompleteness() {
		...
		assertEquals("total number of stops should equal num locations", (onMap.size() * 2) + inCargo.size(), visited.size());
