...
public class SimulationTest {
    ...
    public void setup() throws FileNotFoundException {
        ...
        dummyProgram = new GPProgram<TruckContext>(
                new GPFuncNode<TruckContext>(new Constant<TruckContext>(0)));
    }
    ...
    @Test
    public void test2() {
        final Collection<GPFunc<TruckContext>> funcs = new FRFunctions()
                .create();
        final Simulation sim2 = new Simulation(scenario,
                GPProgramParser.parseProgramFunc("(add 0.0 dist)", funcs),
                false);
    ...
    public void testProgram1() throws ConfigurationException {
        ...
        final GPProgram<TruckContext> prog = GPProgramParser
                .parseProgramFunc(progString, funcs);
